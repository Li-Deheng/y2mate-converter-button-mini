    ...
    try {
      ...
      if (window.trustedTypes) {
        o.innerHTML = trustedTypes.defaultPolicy.createHTML(
          '<img width="32px" height="32px" src="https://user-images.githubusercontent.com/48417413/220382362-140f7b8a-55bf-4197-89a3-0928560f710d.svg">Download'
        );
      } else {
      ...
      o.setAttribute(
        "style",
        "display: flex; justify-content: center; align-items: center; position: relative; cursor: pointer; font: 14px Arial; height: 36px; background: rgba(255,255,255,0.1); color: #f1f1f1; padding: 0 15px 0 5px; margin: 0px 8px; border-radius: 18px; border: none; font-weight: bold"
      );
