// ==UserScript==
// @name        Y2mate Youtube Converter Button (Full)
    ...
    try {
      ...
      if (window.trustedTypes) {
        o.innerHTML = trustedTypes.defaultPolicy.createHTML(
          '<img width="32px" height="32px" src="https://user-images.githubusercontent.com/48417413/224731547-6c5deb0e-d26a-4763-afdb-63f3e4812571.svg">Download'
        );
      } else {
        o.innerHTML = '<img width="32px" height="32px" src="https://user-images.githubusercontent.com/48417413/224731547-6c5deb0e-d26a-4763-afdb-63f3e4812571.svg">Download';
      }
      ...
      o.setAttribute(
        "style",
        "display: flex; justify-content: center; align-items: center; position: relative; cursor: pointer; font: 14px Arial; height: 36px; background: rgba(0,0,0,0.05); color: #0f0f0f; padding: 0 15px 0 5px; margin: 0px 8px; border-radius: 18px; border: none; font-weight: bold"
      );
